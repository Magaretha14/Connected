...
namespace Connected
{
    class Program
    {
            ...
            using (SqlConnection cn = new SqlConnection(connectionString))
            {
                ...
                using (SqlDataReader dr1 = cmd1.ExecuteReader())
                {
                    while (dr1.Read())
                    {
                        ...
                        Console.WriteLine("Data hase been updated");
                    }
                }
            }
            Console.ReadLine();
        ...
        {
            return "data source = LAPTOP-N3UNMQ7P;database=ProdiTI;MultipleActiveResultSets=True;User ID=sa;Password=Puput1414";
        }
    }
}
